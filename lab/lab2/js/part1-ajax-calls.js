/* =====================
  ...
  The first 'recipe' you should write is one that returns true for strings with greater than or equal to 5 characters and false for those shorter than 5 characters.
...
/* =====================
  Now write a 'recipe' to console.log the double of a number (i.e. n * 2). Use the function you write along with underscore's _.each to log the double of every number in the provided array.
===================== */
...
/* =====================
  Given this already defined function, define fizzbuzzArray so that, when mapped over, it will equal ['fizz', 'buzz', 'fizzbuzz'];
===================== */
var fizzbuzzArray = [3, 20, 15];
...
/* =====================
  Writing ajax calls works very much like these higher order functions from underscore. Here's the ajax syntax:
  $.ajax(<URL GOES HERE>).done(<RECIPE GOES HERE>);

  Your job is to write functions and ajax calls for one of the three provided URLs to pull down and then store data collected through AJAX in variables so that you can work with it. To test your success, prove that you can log the resulting data to your console.
...
/* =====================
  Data you grab through ajax is just text. You'll need to parse it as javascript objects to really work with it. Use the function JSON.parse on the string you downloaded for the exercise above to parse your strings as javascript objects.

  Remember to call all code within the function body. Use console.log to make sure that this step is completed before moving on!
===================== */
...
var data = $.ajax(phillyBikeCrashesDataUrl).done(function(data){
